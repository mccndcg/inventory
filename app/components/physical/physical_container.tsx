...
import { ModalNumberInput } from "../NumberInput/NumberInput";
...
export function PhysicalForm({ dexie_good, onSubmitProp }: Props) {
  ...
  return (
    <div className="m-2">
      ...
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(onSubmitProp, (errors) =>
            console.log(errors)
          )}
        >
            ...
            <Table>
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="bg-primary-foreground">
                    Quantity
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {fields.map((ele, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell onClick={() => openNumberForm(index)}>
                      {ele.expiration_date
